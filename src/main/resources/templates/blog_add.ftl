...
<head>
    ...
    <script type="text/javascript">
        ...
        function addTagChange(obj) {
            ...
            //验证标签名称是否重复
            $.ajax({
                url:"/admin/checkTypeAndTag",
                data:{sign:2, tagName:value},
                dataType:'json',
        ...
        function sendBlog(status) {
            ...
            if ($.trim(editor_data) == "") {
                ...
                var subContent = CText.substr(0,450);
            ...
            $.ajax({
                ...
                success:function (result) {
                    if(!result.success){
                        ...
                        window.location.href = "redirect:/admin/blogList";
                    }
                }
            })
        }
...
<section id="getintouch">
    <div class="container">
        <form class="contact" action="/admin/addBlog" method="post" id="blogForm">
            ...
            <div class="row clearfix fcb">
                ...
                <div class="tag-div">
                    <#list tagsList as tag>
                        <span style="width:108px;display: inline-block;"><input type="checkbox" onclick="addTag(this)"
                                                                                data-tagId="tagId_${tag.id}"
                                                                                data-tagName="${tag.tagName}"
                                                                                class="checkbox-style">&nbsp;&nbsp;${tag.tagName}</span>
                    </#list>
                </div>
            </div>
            <div class="row clearfix fcb">
                ...
                <div class="ctrl">
                    <input type="text" name="blogType" onblur="checkTypeName()" id="blogType" style="display:none;width: 120px">
                    ...
                    <a href="javascript:void(0)"><span id="newType" onclick="switchType(0)"
                                                       style="color:#0000FF;">添加新分类</span></a>
                    <a href="javascript:void(0)"><span style="display:none;color:#ff0000;" id="oldType"
                                                       onclick="switchType(1)">使用以前的分类</span></a>
                </div>
            </div>
            <div class="row  clearfix">
